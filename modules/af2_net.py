...
# AlphaFold2 initial release (Jul 15, 2021): commit 1109480e6f38d71b3b265a4a25039e51e2343368
...
def setup_models(neo_num, model_id=4, recycles=1, msa_clusters=1):
    ...
    model_params = data.get_model_haiku_params(model_name=mod, data_dir=script_dir + '/af2_models')
    model_runner = model.RunModel(model_config, model_params)
    # model_runner.model_params = model_params

    # Make separate model runners for each neoantigen to avoid re-compilation and save time.
    model_runners = []
...
def predict_structure(neo_object,
                      ...
                      random_seed=0):
    '''Predicts structure for a given neoantigen using AlphaFold2.'''
